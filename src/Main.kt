fun main() {
    var opcion: Int
    val controlador = Controlador() var mostrarMenu = true
    do {
        if (mostrarMenu) {
            println("¡Bienvenido al sistema de Mudanzas Rincón!.")
        ...
        mostrarMenu = false opcion = readln().toInt() when (opcion) {
            1 -> {
                ...
                println("Registrando Solicitud.") controlador.registrarSolicitud() mostrarMenu = true
            }
            2 -> {
